let rectangleA = (v1, v2) => v1 * v2;
console.log(rectangleA(10, 5));
//////////////////////////////////////////////////////////////////
let circle1 = (rad) => 3.14 * rad * rad;
console.log(circle1(12));
////////////////////////////////////////////////////////////////////
let cylinder1 = (height, rc) => 2 * 3.14 * height * rc;
...
users2Filter(users2);
////////////////////////////////////////////////////////////////////
let article1 = (text) => document.write(`<p>${text}</p>`);
article1('Неможливих речей немає. Є недостатня кількість спроб.');
///////////////////////////////////////////////////////////////////////////
let listUpdate = (textTop) => document.write(`<ul>
                                      <li>${textTop}</li>
                                      <li>${textTop}</li>
                                      <li>${textTop}</li>
                                      </ul>`);
...
listShot(3, 'Hello!');
let chart = ['Leanne Graham', 'Delphine', 'html', 'привіт', 'капучино', 15, 8, true];
let items = (chart) => {
    document.write(`<ul>`);
...
/////////////////////////////////////////////////////////////////////////
let numbersChart = [2, 14, 258, 99, 0, -4, 34];
let minimalVal = (numbersChart) => {
    let min = numbersChart[0];
    {
...
///////////////////////////////////////////////////////////////////////////
let exchangeMoney = (sumUAH, currencyValues, exchangeMoneyCurrency) => {
    let exchangeMoneyRate;
